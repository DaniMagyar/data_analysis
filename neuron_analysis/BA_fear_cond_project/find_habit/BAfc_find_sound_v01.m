function [responses_sound] =  BAfc_find_sound_v01(inputTTLcell)

[~, baseline_data] = BAfc_calc_Zscore_v01('Stims', inputTTLcell,...
    'psth_bin', 3000, 'int', [-20 0]); % each ttl is a column
[~, response_data] = BAfc_calc_Zscore_v01('Stims', inputTTLcell,...
