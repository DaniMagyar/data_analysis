function [psth_spx_dani, idx] =  BAfc_find_shocks_v05(experiment, time_window)

% v4: using parfor loop, faster
% v5:   -removing gaussian filter
...
parfor ii = 1:num_cells
    ...
    smoothed_spike_train = smoothdata(psth_spx_dani(ii,:), 'movmean', 20)
    smoothed_spike_train_zscore(ii,:) = (smoothed_spike_train - mean(smoothed_spike_train(1:baseline_time/bin_time)))...
        / std(smoothed_spike_train(1:baseline_time/bin_time));
end
